...
# Generated by qmake (2.01a) (Qt 4.7.4) on: Wed Apr 4 13:11:52 2012
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/abonent21.0.0/ && $(COPY_FILE) --parents AboHistoryDialog.h AbonentDialog.h AbonentsWindow.h AbonentTypesDialog.h AccrualsPanel.h AccrualsRPanel.h ClientsDialog.h CorrectionsDialog.h DateInputDialog.h FinallyDialog.h mainwindow.h PayDialog.h PaysDialog.h ServicesDialog.h ServicesPanel.h SqlManager.h SummaryCDialog.h SummaryFixCDialog.h TPlansDialog.h UsersDialog.h .tmp/abonent21.0.0/ && $(COPY_FILE) --parents AboHistoryDialog.cpp AbonentDialog.cpp AbonentsWindow.cpp AbonentTypesDialog.cpp AccrualsPanel.cpp AccrualsRPanel.cpp ClientsDialog.cpp CorrectionsDialog.cpp DateInputDialog.cpp FinallyDialog.cpp main.cpp mainwindow.cpp PayDialog.cpp PaysDialog.cpp ServicesDialog.cpp ServicesPanel.cpp SqlManager.cpp SummaryCDialog.cpp SummaryFixCDialog.cpp TPlansDialog.cpp UsersDialog.cpp .tmp/abonent21.0.0/ && (cd `dirname .tmp/abonent21.0.0` && $(TAR) abonent21.0.0.tar abonent21.0.0 && $(COMPRESS) abonent21.0.0.tar) && $(MOVE) `dirname .tmp/abonent21.0.0`/abonent21.0.0.tar.gz . && $(DEL_FILE) -r .tmp/abonent21.0.0
...
compiler_moc_header_make_all: moc_AboHistoryDialog.cpp moc_AbonentDialog.cpp moc_AbonentsWindow.cpp moc_AbonentTypesDialog.cpp moc_AccrualsPanel.cpp moc_AccrualsRPanel.cpp moc_ClientsDialog.cpp moc_CorrectionsDialog.cpp moc_DateInputDialog.cpp moc_FinallyDialog.cpp moc_mainwindow.cpp moc_PayDialog.cpp moc_PaysDialog.cpp moc_ServicesDialog.cpp moc_ServicesPanel.cpp moc_SqlManager.cpp moc_SummaryCDialog.cpp moc_SummaryFixCDialog.cpp moc_TPlansDialog.cpp moc_UsersDialog.cpp
compiler_moc_header_clean:
	-$(DEL_FILE) moc_AboHistoryDialog.cpp moc_AbonentDialog.cpp moc_AbonentsWindow.cpp moc_AbonentTypesDialog.cpp moc_AccrualsPanel.cpp moc_AccrualsRPanel.cpp moc_ClientsDialog.cpp moc_CorrectionsDialog.cpp moc_DateInputDialog.cpp moc_FinallyDialog.cpp moc_mainwindow.cpp moc_PayDialog.cpp moc_PaysDialog.cpp moc_ServicesDialog.cpp moc_ServicesPanel.cpp moc_SqlManager.cpp moc_SummaryCDialog.cpp moc_SummaryFixCDialog.cpp moc_TPlansDialog.cpp moc_UsersDialog.cpp
